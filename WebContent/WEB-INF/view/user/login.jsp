...
<body>
	...
	<div id="login-box">
		<div class="logo">
			<img src="http://cfile288.uf.daum.net/image/220EB7385459AB292F0236" class="img img-responsive img-circle center-block"/>
		...
		<div class="controls">
			...
			<button type="button" class="btn btn-default btn-block btn-custom" onclick="checkValue()">Login</button>
		<a href="/view/user/signin">SignIn</a>
		</div><!-- /.controls -->
	</div><!-- /#login-box -->
</div><!-- /.container -->
