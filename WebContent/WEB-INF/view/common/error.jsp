...
<link rel="stylesheet" href="<%=rootPath%>/ui/css/main.css" />
<body>
...
<link rel="stylesheet" href="<%=rootPath%>/ui/css/bootstrap.css">
<!---- Bootstrap.min link local project skeleton ----->

<link rel="stylesheet" href="<%=rootPath%>/ui/css/w3.css">
		...
		<div class="wrapper">
			...
			<div class="container-fluid" id="body-container-fluid">
				<div class="container">
					...
					<div class="jumbotron">
						<h1 class="display-1">
							5<i class="fa  fa-spin fa-cog fa-3x"></i> 0
						</h1>
						<h1 class="display-3">ERROR</h1>
						<p class="lower-case">Aw !! webpage not found please try to
							refresh</p>
